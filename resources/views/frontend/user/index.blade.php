...
<head>
	...
	<!-- <link rel="stylesheet" media="screen" href="https://s.gr-assets.com/assets/gr/application-70584359e55a1a8fc14d8306ba27eeb9.css" /> -->
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('frontend/css/homelogin.css')}}">
  ...
  <link rel="stylesheet" media="print" href="https://s.gr-assets.com/assets/review/list_print-69cdc091138f212e543aacc82b58622a.css" />
  	<link rel="canonical" href="https://www.goodreads.com/review/list/78270916" />
	<link rel="stylesheet" media="screen" href="https://s.gr-assets.com/assets/gr/application-dcabbeaf9ba6b9da19f242512c98d58a.css" />
						...
						<div class="gr-mediaBox__desc">
							...
							<div class="gr-book__additionalContent">
								<div data-tracking-dfp="true" data-tracking-pmet="{&quot;click_type&quot;:&quot;wtr_button&quot;}">
									<div class="wantToReadButton">
										<div class="wantToReadButton__left wantToReadButton__leftUnshelved">
											<button aria-label="Add Blood River: A Journey to Africa's Broken Heart to your want to read shelf" class="wantToReadButton__leftUnshelvedButton">Want to Read</button>
										</div>
										<div class="dropdown dropdown--wantToReadMenu">
											<button class="dropdown__trigger dropdown__trigger--wantToReadMenu dropdown__trigger--buttonReset dropdown__trigger--triggerEventTypeHover" aria-haspopup="true" aria-expanded="false">
												<div class="wantToReadButton__right">
													<span class="u-visuallyHidden">Shelving menu</span>
												</div>
											</button>
											<div class="dropdown__menu dropdown__menu--wantToReadMenu gr-box gr-box--withShadowLarge" role="menu">
												<div class="wantToReadMenu__scrollableContainer">
													<li class="wantToReadMenu__shelfItem">
														<button class="wantToReadMenu__exclusiveShelf" aria-label="Shelve Blood River: A Journey to Africa's Broken Heart as Read">Read</button>
													</li>
												</div>
											</div>
										</div>
